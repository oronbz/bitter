...
func helpContent() string {
	...
	sb.WriteString(k.Render("Enter") + d.Render("Select item") + "\n")
	...
	sb.WriteString(k.Render("o") + d.Render("Open build in browser") + "\n")
	sb.WriteString(k.Render("c") + d.Render("Copy build URL") + "\n")
